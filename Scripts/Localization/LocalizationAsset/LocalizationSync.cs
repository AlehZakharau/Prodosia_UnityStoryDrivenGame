...
//Этот скрипт (и одноименный объект на сцене меню) нужны для подгрузки таблички-словаря
//Скрипт и объект будут удалены перед сборкой финального билда
//Пока не удалять!
...
namespace Assets.SimpleLocalization
{
	...
	public class LocalizationSync : MonoBehaviour
	{
		...
		/// 1FccveOiU0quTOH960M4T43b8-K6Y6PHPLe4Djzv9wVw/edit#gid=0
